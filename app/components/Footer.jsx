...
const Footer = () => {
  return (
    <footer
      className="footer bg-[#4B2E13] text-white pt-12 pb-6"
      id="contact-us"
    >
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index}>
                  <Link
                    href={item.href}
                    className="footer-link hover:text-amber-300 transition"
                  >
                    {item.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-4">
              <li className="footer-item flex items-start">
                ...
                <div className="space-y-1">
                  {["+254 718510450", "+254 722600891", "+254 745070976"].map(
                    (phone, index) => (
                      <Link
                        key={index}
                        href={`tel:${phone.replace(/\s/g, "")}`}
                        className="footer-item-link block hover:text-amber-300 transition"
                      >
                        {phone}
                      </Link>
                    )
              ...
              <li className="footer-item flex items-start">
                ...
                <div className="space-y-1">
                  {["gideonkipamet@gmail.com", "hubmzinga@gmail.com"].map(
                    (email, index) => (
                      <Link
                        key={index}
                        href={`mailto:${email}`}
              ...
              <li className="footer-item flex items-start">
                ...
                <address className="footer-item-link not-italic">
                  Rimpa, Kajiado, Kenya
                </address>
              </li>
            </ul>
